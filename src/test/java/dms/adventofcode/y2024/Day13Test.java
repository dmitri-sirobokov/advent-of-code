...
class Day13Test {
    ...
    @ParameterizedTest
    @TestInput(input = "y2024/day13_sample.txt", expected = "480")
    @TestInput(input = "y2024/day13.txt", expected = "35255")
    ...
    @ParameterizedTest
    @TestInput(input = "y2024/day13.txt", expected = "87582154060429")
